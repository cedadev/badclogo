...
411       FORMAT('PV at ',A,' = ',A) 
          CALL PRINTA2 (PV(1,J1), NX, IX1, IX2, IY1, IY2,
     *    LABEL, GRID, LUN_PRT)   
...
412         FORMAT('U wind at ',A,' = ',A) 
            CALL PRINTA2 (U(1,J1), NX, IX1, IX2, IY1, IY2,
     *      LABEL, GRIDW, LUN_PRT)   
            WRITE(LABEL,413) PVLEVT(IOUTL), PVLEVV 
413         FORMAT('V wind at ',A,' = ',A) 
            CALL PRINTA2 (V(1,J1), NX, IX1, IX2, IY1, IY2,
     *      LABEL, GRIDW, LUN_PRT)   
            WRITE(LABEL,414) PVLEVT(3-IOUTL),PVLEVT(IOUTL), PVLEVV 
414         FORMAT(A,' at ',A,' = ',A) 
            CALL PRINTA2 (THETAP(1,J1), NX, IX1, IX2, IY1, IY2,
     *      LABEL, GRID, LUN_PRT) 
          END IF
        END DO 
      END DO 
