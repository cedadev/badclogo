...
C                                                                               
CL    Opens the specified Met Office (UKMO) correlative data file               
CL    Version 5c (Aug 03):
CL      default fields and levels changed to New Dynamics standards
CL      (omega is replaced by vertical velocity w)
CL      New field types for RH and w             
CL      VAX-specific code (delineated by *IF VAX) deleted                       
C                                                                               
...
*             42=W, 45=SIGDT, 48/56=U, 49/57=V ,63=KE, 73=VORT, 74=DIV,         
...
C     MONTH3       3-digit abbreviations for months                             
      DATA ITYPE /                                                              
     + 'ZONWIN_P    ','MERWIN_P    ','HEIGHT      ','TEMP        ',             
     + 'VERWIN_P    ','RH          ','OMEGA       ','O3          ',             
     + 'H2O         ','CO          ','CH4         ','N2O         ',             
     + 'NO          ','NO2         ','HNO3        ','N2O5        ',             
     + 'ClONO2      ','ClO         ','HCl         ','CF2Cl2      ',             
     + 'CFCl3       ','HF          ','            ','            '/             
      DATA IFC/                                                                 
     + 56            ,57            ,1             ,16            ,             
     + 42            ,88            ,40            ,501           ,             
...
CL--- v5c - change default fields for New Dynamics
      IF (KLFAST) THEN                                                          
        PLEVMIN=0.1                                                           
        PLEVMAX=1000.0                                                          
        DATE='    '                                                             
